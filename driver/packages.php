<section class="page-section bg-dark" id="home">
	...
	<div class="d-flex w-100">
            <div class="card w-100 rounded-0">
                <img class="card-img-top" src="" alt="" height="200rem" style="object-fit:cover">
                <div class="card-body">
                <h5 class="card-title truncate-1"></h5>
                <p class="card-text truncate"></p>
                <div class="w-100 d-flex justify-content-end">
                    <a href="./?page=packages&id=" class="btn btn-sm btn-flat btn-warning">View Package <i class="fa fa-arrow-right"></i></a>
                </div>
                </div>
            </div>
	</div>
